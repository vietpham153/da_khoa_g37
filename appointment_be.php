...
if (!empty($_SESSION['uuid'])) {
    ...
    $insert_appointments_full = "INSERT INTO appointments (user_uuid, doctor_uuid, name, email, status, 
                                        note, day_id, shift_id, created_at, updated_at)
                                        VALUES ('$user_uuid', '$doctor_uuid', '$name', '$email', '0', '$note', '$day_id', '$shift_id', '$datetime', '$datetime')";
